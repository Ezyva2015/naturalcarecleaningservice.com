<?php
    ...
    if($_SERVER['REQUEST_METHOD'] == 'POST' && $_POST['FirstName'] != '' && $_POST['Address'] != '' && $_POST['Email'] != '')
    {
        ...
        // $variable['apt']     = $_POST['StreetAddress2'];  
        // $variable['name']    = $_POST['FirstName'];
        // $variable['email']   = $_POST['Email'];
        // $variable['phone']   = $_POST['phonenum'];
    }
...
if(isset($redirect)) {  ?> 
    <style type="text/css"> .submit-loading {  display:block; }  </style>  
      <!-- echo "<h1> Redirect Now.... </h1>"; -->
     <!-- echo $redirect; --> 
<?php } else { ?> 
     <style type="text/css"> .submit-loading { display:none;  } </style>  
<?php  } ?> 
                                            ...
                                            <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>" method="post" name="start" id="start" role="form" autocomplete="off">
                                                <div> 
                                                    ...
                                                    <div id="locationField" class="form-group center"> 
													  <md-content md-theme="docs-dark" layout-padding="" layout="row" layout-sm="column">
														<md-input-container>
														    ...
														    <input ng-model="user.address" onclick="exec_clicked()" autocomplete="false" style="height: 30px; border-radius:0 !important;" placeholder="Enter your street address…" tabindex="10" g-places-autocomplete="" force-selection="true" type="text" class="input-medium google-addresses-autocomplete needs-value" id="autocomplete" 
                                                                name="Address" value="Alright"    
                                                            />
														</md-input-container>
													  </md-content>	  
                                                    </div>
                                                   ...
                                                   <div class="form-group center">
                                                    ...
                                                    <div align="center"> 
                                                     <button type="submit" style="height: 42px; background: #FD7F23; color: white; font-size: 20px" id="continue" name="continue" class="btn2 btn-grad col-xs-12 center"> 
                                                        <center>
                                                            <table> 
                                                                <tbody>
                                                                    <tr>
                                                                        ...
                                                                        <td>
                                                                            <img src="http://naturalcarecleaningservice.com/wp-content/uploads/2016/04/spinner.gif" class="submit-loading"> 
                                                                        </td> 
                                                                    </tr>
                                                                </tbody>
                                                            </table> 
