...
/* 							$('.pac-container').remove();
				...
				$('#start').click(callformclick);
				$('#start').focusout(callformclick);
				
				

				function callformclick(){
					...
					if($('#autocomplete').val().length<firstResult.length){
            ...
            <div id="content" style="margin-left:0px; margin-right:0px; padding: 0px">
                    <div class="row-fluid">
                        ...
                        <div class="col-lg-12" style="padding: 0px">
                            ...
                            <div style="margin-bottom:0px !important" class="panel panel-default">
                                            ...
                                            <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>" method="post" name="start" id="start" role="form" autocomplete="off">
                                                <div>
                                                    ...
                                                    <div id="locationField" class="form-group center">
                                                        ...
                                                        <input onclick="exec_clicked()" autocomplete="false" style="height: 42px" placeholder="Enter your street address…" tabindex="10" g-places-autocomplete="" force-selection="true" required type="text" class="form-control google-addresses-autocomplete" id="autocomplete"  placeholder="Enter your address" value=""   >
                                                        </input>
														
														<input style="display:none;" name="Address" type="text" id="realaddress" value="" />
                                                    </div>
