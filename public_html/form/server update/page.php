...
require_once ('tj.intuitiveperception.com/naturalcare/infusionsoft/PHP-iSDK-master/src/isdk.php');
require_once ('tj.intuitiveperception.com/naturalcare/stripe/init.php');
require_once ('tj.intuitiveperception.com/naturalcare/conf.php');
...
<?php get_header(); ?>
    ...
    <head>
        ...
        <!-- GLOBAL STYLES -->
        <link rel="stylesheet" href="tj.intuitiveperception.com/naturalcare/assets/plugins/bootstrap/css/bootstrap.css" />
        <link rel="stylesheet" href="tj.intuitiveperception.com/naturalcare/assets/css/main.css" />
        <link rel="stylesheet" href="tj.intuitiveperception.com/naturalcare/assets/css/theme.css" />
        <link rel="stylesheet" href="tj.intuitiveperception.com/naturalcare/assets/css/MoneAdmin.css" />
        <link rel="stylesheet" href="tj.intuitiveperception.com/naturalcare/assets/plugins/Font-Awesome/css/font-awesome.css" />
        <!--END GLOBAL STYLES -->

        <!-- PAGE LEVEL STYLES -->
        <link href="tj.intuitiveperception.com/naturalcare/assets/css/booknow.css" rel="stylesheet" />
        <link href="tj.intuitiveperception.com/naturalcare/assets/css/jquery-ui.css" rel="stylesheet" />
        <link rel="stylesheet" href="tj.intuitiveperception.com/naturalcare/assets/plugins/datepicker/css/datepicker.css" />
        <!-- END PAGE LEVEL  STYLES -->

        <!-- GLOBAL SCRIPTS -->
        <script src="tj.intuitiveperception.com/naturalcare/assets/plugins/jquery-2.0.3.min.js"></script>
        <script src="tj.intuitiveperception.com/naturalcare/assets/plugins/bootstrap/js/bootstrap.min.js"></script>
        <script src="tj.intuitiveperception.com/naturalcare/assets/plugins/modernizr-2.6.2-respond-1.1.0.min.js"></script>
        <!-- END GLOBAL SCRIPTS -->
        <!-- PAGE LEVEL SCRIPTS -->
        <script src="tj.intuitiveperception.com/naturalcare/assets/js/jquery-ui.min.js"></script>
        <script src="tj.intuitiveperception.com/naturalcare/assets/plugins/validVal/js/jquery.validVal.min.js"></script>
        <script src="tj.intuitiveperception.com/naturalcare/assets/js/bootstrap-datepicker.js"></script>
        <script src="tj.intuitiveperception.com/naturalcare/assets/plugins/jasny/js/bootstrap-inputmask.js"></script>
        <script src="tj.intuitiveperception.com/naturalcare/assets/js/formsInit.js"></script>
        <script src="tj.intuitiveperception.com/naturalcare/assets/js/validationInit.js"></script>
        <script src="tj.intuitiveperception.com/naturalcare/assets/plugins/validationengine/js/jquery.validationEngine.js"></script>
        <script src="tj.intuitiveperception.com/naturalcare/assets/plugins/jquery-validation-1.11.1/dist/jquery.validate.js"></script>
        <script src="tj.intuitiveperception.com/naturalcare/assets/plugins/jasny/js/bootstrap-inputmask.js"></script>
        <link type="text/css" rel="stylesheet" href="https://fonts.googleapis.com/css?family=Roboto:300,400,500">
        <script src="https://maps.googleapis.com/maps/api/js?v=3.exp&signed_in=true&libraries=places"></script>
        <script src="tj.intuitiveperception.com/naturalcare/assets/js/jquery-scrolltofixed.js" type="text/javascript"></script>
                                    ...
                                    <div class="row-fluid">
                                        <div style="padding: 0px !important" class="form-group" value="">
                                            ...
                                            <div  style="left: -20px" class="col-xs-3 col-md-3" align="center">
                                                <input name="Fridge" id="fridge" value="" class="addon" type="image" src="tj.intuitiveperception.com/naturalcare/assets/img/33.png"</input>

                                                </div>
                                                <div  style="left: -20px" class="col-xs-3 col-md-3" align="center">
                                                <input name="Stove" id="stove" value="" class="addon" type="image" src="tj.intuitiveperception.com/naturalcare/assets/img/22.png"</input>

                                                </div>

                                                <div  style="left: -20px" class="col-xs-3 col-md-3" align="center">
                                                <input name="Window" id="window" value="" class="addon" type="image" src="tj.intuitiveperception.com/naturalcare/assets/img/44.png"</input>

                                                </div>

                                                <div  style="left: -20px" class="col-xs-3 col-md-3" align="center">
                                                <input name="BedSteam" id="wall" value="" class="addon" type="image" src="tj.intuitiveperception.com/naturalcare/assets/img/55.png"</input>
                                            ...
                                            <img id="ccimage" style="width:240px" src="tj.intuitiveperception.com/naturalcare/assets/img/cc_logo.png">
                                            </div>
                                            ...
                                            <div class="col-sm-3">
                                            <img style="height: 24px" src="tj.intuitiveperception.com/naturalcare/assets/img/House.png" />
                                        </div>
                                        <div class="col-sm-9">
                                        ...
                                        <div class="summary col-sm-12">
                                        <div class="col-sm-3">
                                        <img style="height: 24px" src="tj.intuitiveperception.com/naturalcare/assets/img/Calendar.png" />
                                        </div>
                                        <div class="col-sm-9">
                                        ...
                                        <div class="summary col-sm-12">
                                        <div class="col-sm-3">
                                        <img style="height: 24px" src="tj.intuitiveperception.com/naturalcare/assets/img/Clock.png" />
                                    </div>
                                    <div class="col-sm-9">
                                        <span id="hour"></span>
                                    </div>
