...
//			$('#pvisit1').text('$' + Math.round(firstclean).toFixed(0));
	...
	<!-- BEGIN BODY -->
	<body style="background-color: white; padding-top:0px;" onload="init();">
		...
		<h2>Edit your Information</h2>
			<form role="form"  id="idForm" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>" method="post">
				<div class="form-group" style="padding-left:0px !important;">
					...
					<input type="text" name="name" class="form-control" value="<?= isset($_SESSION['FirstName'])?$_SESSION['FirstName']:'' ?>" required>
				</div>
				<div class="form-group" style="padding-left:0px !important;">
...
<!--                                                        		</select>-->
									...
									<h3 class="ip-subheader">Select your cleaning date and arrival window</h3>
												...
												<div class="form-group">
												<div style="padding-left:0px" class="phone col-xs-12 col-md-6">
												<input id="street_address" name="StreetAddress1" value="<?php isset($_SESSION['StreetAddress1'])?$_SESSION['StreetAddress1']:'' ?>" class="form-control" placeholder="Street Address" />
												</div>
												<div style="padding-left:0px" class="phone col-xs-12 col-md-6">
						...
						<div class="summary" style="padding-left:15px;">
							<div class="summary row">
								...
								<div class="col-md-5">
									<span class="name-edit"><?= isset($_SESSION['City'])?$_SESSION['City']:'' ?></span>
								</div>
								<div class="col-md-1">
							...
							<br>
							<div class="summary row" style="border-top:1px solid #dedede;">
								<div class="col-md-1">
		  ...
		  <script type="text/javascript">
			$(document).ready(function(){
				$("#idForm").submit(function() {
						...
						var fnmehndler = $('#idForm input[name=name]').val();
						var fullname = fnmehndler.split(' ')
					
						$('.name-edit').html($('#idForm input[name=name]').val());
