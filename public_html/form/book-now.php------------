...
if (isset($_SESSION) && !empty($_SESSION) && isset($_SESSION['contact_id']))
{
    if ($_SERVER['REQUEST_METHOD']=='POST' && $_POST['_Frequency']!='' && $_POST['_SelectYourDate']!='' && $_POST['_ArrivalWindow']!='' && $_POST['_InitialCleanType']!='' && $_POST['FirstName']!='' && $_POST['City']!='' && $_POST['LastName']!='' && $_POST['Email']!='' && $_POST['Phone1']!='' && $_POST['StreetAddress1']!='' && $_POST['State']!='' && $_POST['PostalCode']!='' && $_POST['credit_card']!='' && $_POST['cvc']!='' && $_POST['expmonth']!='' && $_POST['expyear']!='')
    {
        ...
        header("Location: /form/final.php");
    }
}
?>
<!DOCTYPE html>
...
var subtotal = (base)+((<?php echo $_SESSION['_Beds']?>)*beds)+((<?php echo $_SESSION['_baths']?>)*baths)+
((<?php echo $_SESSION['_SquareFootagesize']?>-sqft>0?<?= $_SESSION['_SquareFootagesize']?>
	-sqft:0)/100)*3;
	...
	$('.cleantype').click(function() {
		...
		$('#Ivisit1').val((firstclean * 100).toFixed(0))
		$('#Ivisit2').val((recurringPrice * 100).toFixed(0))
					...
					<form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>" method="post" id="step1" role="form">
						...
						<div class="container-fluid" style="padding:0px">
							<section class="col-xs-12" style="padding:0px">
								...
								<div class="col-xs-12 col-md-6 col-sm-8 col-lg-5 col-lg-offset-3 col-md-offset-2" style="background:white; padding-left:0%; padding-bottom:25px; padding-top: 1%">
									...
									<div style="padding-left:25px; padding-right: 12px" class="form-group; container-fluid">
										<a href="#" name="freq" onclick="onetime()" class="btn btn-default btn-lg btn-line repeat col-xs-5 col-md-3">1 time service</a><div class="col-xs-1 hidden-sm hidden-md hidden-lg"></div>
										<a href="#" name="freq" onclick="weekly()" class="btn btn-default btn-lg btn-line repeat col-xs-5 col-md-3">Every week</a>
										<a href="#" name="freq" onclick="biweekly()" class="btn btn-default btn-lg btn-line repeat col-xs-5 col-md-3">Every 2 weeks</a><div class="col-xs-1 hidden-sm hidden-md hidden-lg"></div>
										<a href="#" name="freq" onclick="monthly()" class="btn btn-default btn-lg btn-line repeat col-xs-5 col-md-3">Every 4 weeks</a>
									</div>
									...
									<div style="padding-left:25px; padding-right: 12px" class="form-group; container-fluid">
										<a href="#" id="clean" onclick="getclean()" class="clean btn btn-default btn-lg btn-line cleantype col-xs-4 col-md-3">Get it Clean</a><div class="col-sm-1"></div>
										<a href="#" id="deep" onclick="deepclean()" class="deep btn btn-default btn-lg btn-line cleantype col-xs-4 col-md-3">Deep Clean</a><div class="col-sm-1"></div>
										<a href="#" id="move" onclick="moveinout()" class="move btn btn-default btn-lg btn-line cleantype col-xs-4 col-md-3">Move In/Out</a>
									</div>
									<center><span style="padding-left:30px; width: 50%">
									...
									<div class="row-fluid">
										<div style="padding: 0px !important" class="form-group" value="">
											...
											<div  style="left: -20px" class="col-xs-3 col-md-3" align="center">
												...
												<input style="text-align: center" type="text" placeholder="mm/dd/yyyy" class="form-control datepicker" name="_SelectYourDate" data-date-format="mm/dd/yyyy" id="datepicker" />
												</div>
												...
												<a href="#" id="after" onclick="afternoon()" style="bottom:4px; margin-left:35px" class="btn btn-lg btn-default btn-line daytime col-xs-4 col-sm-3 col-md-2">Afternoon</a><br><br><br>
												<center><span style="padding-left:30px; width:50%">
											...
											<div id="summary" class="summary col-sm-3 col-md-2 show-sm hidden-xs">
											<div class="summary">
